					...
					<div class="row">
						...
						<div class="col-sm-5 col-md-4">
							...
							<ul class="address-list">
								<li>
										<h5>Address</h5>
										<address> XYZ <br/> abc <br/></address>
								</li>
								<li>
										<h5>Email</h5><a href="ashkarrahim21@gmail.com">ashkarrahim21@gmail.com</a>
								</li>
								<li>
										<h5>Phone Number</h5><a href="tel:+91 8921981706">+91 8921981706</a>
								</li>
