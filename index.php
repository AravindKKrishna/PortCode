		...
		<div class="main-wrapper">
			...
			<div class="hero" style="background-image:url('images/hero-header/01.jpg');">
				<div class="container">
					...
					<p>Finding your next job or career on JobQuest</p>
					...
					<div class="container">
						...
						<div class="row">
								...
								<div class="row">
									...
									<div class="col-sm-6 col-md-4">
										...
										<div class="footer-about-us">
											<h5 class="footer-title">About NightQuest</h5>
											<p>NightQuest is a job portal, online job management system developed by Nathaniel Nkrumah for his project in february 2018.</p>
							...
							<div class="col-sm-12 col-md-3 mt-30-sm">
								...
								<h5 class="footer-title">NightQuest Contact</h5>
								
								<p>Address : XYZabc</p>
								<p>Email : <a href="ashkarrahim21@gmail.com">ashkarrahim21@gmail.com</a></p>
								<p>Phone : <a href="tel:+91 8921981706">+91 8921981706</a></p>
					...
					<div class="container">
						...
						<div class="row">
							...
							<div class="col-sm-4 col-md-4">
								...
								<p class="copy-right">&#169; Copyright <?php echo date('Y'); ?> NightQuest Vision Software</p>
